...
f <- list.files(here('data/dglnrt_v2_simulation_partially_identified'))
...
for(kk in 1:100){
  ...
  ch <- file.exists(here(paste0('data/dglnrt_v2_simulation_partially_identified/rep',kk,'.RData')))  
  
  if(ch==TRUE){
    
    load(here(paste0('data/dglnrt_v2_simulation_partially_identified/rep',kk,'.RData')))
