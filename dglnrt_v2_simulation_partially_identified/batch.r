...
for(i in 1:100){
  ...
  a <- rbind(a,paste0('#SBATCH --output=/gpfs/projects/edquant/cengiz/dglnrt_partial/rep',i,'.out'))
  a <- rbind(a,paste0('#SBATCH --error=/gpfs/projects/edquant/cengiz/dglnrt_partial/rep',i,'.err'))
  ...
  a <- rbind(a,"")
  a <- rbind(a,paste0('R --no-save < /gpfs/projects/edquant/cengiz/dglnrt_partial/rep',i,'.r'))
  
  a <- noquote(a)
  
  write(a,paste0('/gpfs/projects/edquant/cengiz/dglnrt_partial/batch',i,'.batch'))
}
