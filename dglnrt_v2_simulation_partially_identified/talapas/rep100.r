...
# A generic function to simulate DG-LNRT data with item preknowledge
...
mod <- cmdstan_model('/gpfs/projects/edquant/cengiz/dglnrt_partial/dglnrt2.stan')
...
save.image('/gpfs/projects/edquant/cengiz/dglnrt_partial/rep100.RData')
